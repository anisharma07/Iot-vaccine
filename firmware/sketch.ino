...
void printDashboard() {
  ...
  Serial.print(",\"accel\":");    Serial.print(accelMag, 0);
  Serial.print(",\"gyro\":");     Serial.print(gyroSpeed, 0);
  Serial.print(",\"tamper\":");   Serial.print(tampered ? 1 : 0);
  Serial.print(",\"status\":");   Serial.print(status_code);
  Serial.print(",\"damage\":");   Serial.print(damageScore);
  Serial.println("}");
}
...
const char* getStatusLabel(int code) {
  switch (code) {
    case 0: return "❄️  COLD CHAIN FAILURE   ";
    case 1: return "✅ NORMAL / OK           ";
    case 2: return "🔓 TAMPER DETECTED       ";
    case 3: return "💥 SHOCK / DROP          ";
    case 4: return "🏎️  UNSAFE DRIVING       ";
    case 5: return "🌫️  GAS LEAKAGE          ";
    case 6: return "💧 HIGH HUMIDITY         ";
